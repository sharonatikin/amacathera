...
// // Updated navigation items based on website recommendations
// const navItems = [
//   "Home",
//   "About Us",
//   "Hydrogel Platform",
...
//   // Define subtabs for dropdown menus
//   const subNavItems = {
//     "About Us": ["Company", "Our Team", "Board of Directors", "Investors", "Collaborations and Partnering"],
//     "Hydrogel Platform": ["Our Platform", "About AMT-143", "Publications", "Frequently Asked Questions"],
//     "News & Events": ["Press Releases", "In the News", "Events"]
//   };
...
//                 className="text-slate-700 hover:text-blue-900 font-medium transition py-2"
//               >
//                 {item}
//               </a>
...
//                   {subNavItems[item].map((subitem) => (
//                     <a
//                       key={subitem}
//                       href={`/${item.toLowerCase().replace(/\s+/g, '-')}/${subitem.toLowerCase().replace(/\s+/g, '-')}`}
//                       className="block px-4 py-2 text-slate-700 hover:text-blue-900 hover:bg-blue-50 transition"
//                     >
//                       {subitem}
//                     </a>
//                   ))}
...
//                 <a
//                   href={item === "Home" ? "/" : `/${item.toLowerCase().replace(/\s+/g, '-')}`}
//                   onClick={() => !subNavItems[item] && setIsMobileMenuOpen(false)}
//                   className="block px-4 py-3 text-slate-700 hover:text-blue-900 hover:bg-blue-50 font-medium transition rounded-lg"
//                 >
//                   {item}
//                 </a>
...
//                         href={`/${item.toLowerCase().replace(/\s+/g, '-')}/${subitem.toLowerCase().replace(/\s+/g, '-')}`}
//                         onClick={() => setIsMobileMenuOpen(false)}
//                         className="block px-4 py-2 text-sm text-slate-600 hover:text-blue-900 hover:bg-blue-50 transition rounded-lg"
//                       >
//                         {subitem}
//                       </a>
//                     ))}
