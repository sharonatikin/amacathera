        ...
        <div className="space-y-8 md:space-y-12 ">
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <p className="text-base sm:text-lg md:text-lg text-primary leading-relaxed max-w-xl">
              We're looking for team members who share our collective motivation to solve healthcare challenges that benefit humanity, but who are also keen to look differently at the therapeutics ecosystem and challenge conventions in how drugs are made and delivered.
            </p>
          </div>
