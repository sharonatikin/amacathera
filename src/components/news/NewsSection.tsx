          ...
          >
            <div className="flex items-center justify-center">
              <div className="relative w-full max-w-md bg-gray-300 h-64 rounded-3xl shadow-xl flex items-center justify-center">
                ...
                <Image
                  src={newsData[activeSlide]?.imageUrl ? `/api/images/${newsData[activeSlide].imageUrl}` : '/logos/Amaca_Thera_Logo_PNG.png'}
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between gap-3 mt-2">
                <Link href={`/news-and-events/news/${newsData[activeSlide].slug || newsData[activeSlide]._id}`} className='bg-[#1e3a5f] hover:bg-[#2d5a8f] text-white px-6 py-3 rounded-lg font-semibold text-sm flex items-center gap-2 transition-colors cursor-pointer'>
                  <span>Read More</span>
