  ...
  return (
    <Link href={`/team/${member.url}`}  className="flex flex-col">
      ...
      <div className=" overflow-hidden flex flex-col items-center  flex-grow">
        ...
        {/* Name and Title Card */}
        <div className="bg-blue-900 lg:min-w-xs px-10 rounded-2xl pt-30 text-white py-8 text-center mt-4">
      ...
      <div className="  px-6 py-6 -mt-5 relative  right-0  bg-white/0 backdrop-blur-lg rounded-xl border border-white/30 shadow-xl min-w-[200px]">
